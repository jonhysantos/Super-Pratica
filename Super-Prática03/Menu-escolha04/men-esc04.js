...
import {dobro,somar,subtrair} from './Funções04.js'
...
function calcularSoma(){
    ...
    let n1 = parseFloat(prompt('Digite o segundo número:'))
...
}while(escolha !== 4) // tudo isso se caso escolha for diferente de 4, que nesse caso é sair.
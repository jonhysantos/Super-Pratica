...
for(tries = 1; tries <= 10 ; tries ++){
    let guess = parseInt(prompt(`Tentativa ${tries} / ${maxTries}.Adivinhe o número de 1 a 100`))
...
if(tries > maxTries){
    alert(`Suas ${maxTries} / ${maxTries} acabaram.O numero era ${randomN}, tente novamente`)
}
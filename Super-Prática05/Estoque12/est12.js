...
function listarItem(){
    ...
    // Transforma uam lista de objetos em uma lista de strings e depois junta tudo.
...
function alterarQuantidade(){
    ...
    if(isNaN(indice) || indice < 0 || indice >= estoque.length){
        alert('Número do item inválido ou inexistente.')
        return
    }
...
function excluirItem(){
    ...
    const indice = parseInt(prompt('Digite o número que deseja excluir do estoque:')) -1

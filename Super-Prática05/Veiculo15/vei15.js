const veiculo = {
    ...
    diminuirVelociade:function(desaceleracao){
...
while(true){
    ...
    switch(escolha){
        case "1":
            ...
            break
        case "2":
            const desaceleracao = parseFloat(prompt('Digite a quantidade de desaceleração que deseja:'))
            veiculo.diminuirVelociade(desaceleracao)
            break
        case "3":

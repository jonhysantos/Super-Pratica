...
const playGame = (human,machine) => {
    ...
    if(human === machine){
        ...
        result.innerHTML = `Você venceu! porque você escoheu ${human} e a Alexa ${machine}`
    }else{
        result.innerHTML = `Perdeu para a Alexa porque você escoheu ${human} e a Alexa ${machine}`
    }
}